...
# thanks: "Corresponding author: [yuehong-tai@uiowa.edu](mailto:yuehong-tai@uiowa.edu). Current version: `r format(Sys.time(), '%B %d, %Y')`.  Replication materials and complete revision history may be found at [https://github.com/fsolt/janitor_work](https://github.com/fsolt/janitor_work)."
author:
# - Yue Hu
...
## Data-Entry Errors and Democratic Support {.unlisted .unnumbered}
...
Although failure to find support for a research hypothesis may prompt us to undertake such a close review, an analysis that yields statistical significance is unlikely to trigger what will likely be, as in the above example, a time-consuming and difficult effort.
...
First, __automate data entry__: we suggest researchers consider reducing reliance on manual data entry and increasing the extent to which data wrangling is performed computationally.
Readers should be aware that our suggestion does not imply that computers are _always_ superior to people for this purpose. 
...
In fact, many common janitor-work chores already have been packaged as open-source software that to make researchers' task both easier and more straightforward.^[
...
Nevertheless, careful attention can minimize the threat of data-entry errors to our 'janitor work', our research, and our understanding of the world and maximize the transparency, openness, and credibility of our research.
